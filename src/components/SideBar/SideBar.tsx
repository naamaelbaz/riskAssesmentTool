...
const getIconByDomain = (domain: string, color: string) => {
    switch (domain) {
      case "Impact":
        return <CrisisAlertIcon style={{ color }} />;
      case "Capabilty":
        return <ConstructionIcon style={{ color }} />;
      case "Model Type & Risk":
        return <ModelTrainingIcon style={{ color }} />;
      default:
        return null;
    }
  };
  ...
  onToggle
    ...
    return (
        ...
        <div className="sidebar-header">
            <MenuIcon onClick={onToggle} className="menu-icon" />
        </div>
